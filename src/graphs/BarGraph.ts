...
export default class DoughnutGraph extends GraphBase {
	 ...
	 */
	constructor(statsmanager: StatsManager, options: BarGraphOptions = {}) {
	...
	/**
	 * @param {BarStats[]} data - Data to generate the graph
	 * @returns {Promise<Buffer>} - Promise that resolve to the generated graph
	 */
	async generateCanvas(data: BarStats[]): Promise<Buffer> {
